...
<link rel="stylesheet" type="text/css" href="comics-container.css">
...
<div style="background-color:black;">
	<div class="header">
	    <a  href="homepageresp.php"><img id="marvel_logo" src="Marvel-logo.png" title="Home"></a>
	<div class="header_content">
		<div class="socialplatform">
			...
			<?php if(isset($_SESSION['success']) and isset($_SESSION['user'])): ?>
					<a  id="signin" style="text-transform: uppercase" title="" href="profile.html">
						HELLO 
						<?php 
							echo $_SESSION['user'];  
						?>
					...
					<a  id="signin" title="" href="homepageresp.php">
						LOGOUT
						<?php 
...
<div class="Rnavigator" id="Rmynavigate">

			<ul class="Rnavigate">
				<li><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a></li>
				<li><a href="homepageresp.html">HOME</a></li>
				<li><a href="latestnews.html" >LATEST NEWS</a></li>
			    <li><a href="comics.html">COMICS</a></li>
				<li><a href="http://marvel.com/movies">MOVIES</a></li>
				<li><a href="http://marvel.com/videos">VIDEOS</a></li> 
				...
				<li><a href="http://marvel.com/characters">CHARACTERS</a></li>
				<li><a href="http://shop.marvel.com/">SHOP</a></li>
				<li><a href="http://marvel.com/search" >SEARCH</a></li>
				<li><a style="background-color:black" id="mastercard" title="mastercard" href="http://marvel.com/creditcard?siteCode=MCLAMONB&amp;cmpid=MCLAMONB&amp;Dcom=MOLNAV" >Marvel Mastercard<sup>®</sup></a></li>
				<li><a style="background-color:black" id="insider" title="insider" href="http://marvel.com/insider?start_location=topnav" >Join Marvel Insider!</a></li>
				<!--li><a style="background-color:black" id="signin" title="sign in" href="newsignupresp.html">SIGN IN</a></li-->
				<!---------->
				
			<?php if(!isset($_SESSION['success'])): ?>
					<li><a style="background-color:black" id="signin" title="sign in" href="newsignupresp.php">SIGN IN</a></li>
			<?php endif?>
			<?php if(isset($_SESSION['success']) and isset($_SESSION['user'])): ?>
					<li>
						<a style="background-color:black;text-transform: uppercase;" id="signin" title="" href="profile.html">
							HELLO 
							<?php 
								echo $_SESSION['user'];  
							?>
					...
					<li>
						<a style="background-color:black" id="signin" title="" href="homepageresp.php">
							LOGOUT
							<?php 
							unset($_SESSION['success']);
							unset($_SESSION['user']);
			...
			<?php endif?>
				...
				<!-------------------->
				<li><a style="background-color:black" class="socialmedia" href="http://www.facebook.com/Marvel/"><img src="fb_logo.png" width="30" height="30" title="Facebook"></a></li>
				<li><a style="background-color:black" class="socialmedia" href="http://twitter.com/Marvel"><img src="twitter_logo.png" width="30" height="30" title="Twitter"></a></li>
				<li><a style="background-color:black" class="socialmedia" href="http://www.youtube.com/channel/UCvC4D8onUfXzvjTOM-dBfEA"><img src="youtube_logo.png" width="30" height="30" title="YouTube"></a></li>
...
<div style="background-color:black">
	<div id="slideshow_container">
		...
		<div id="text-container">
			<h2><a  href="https://news.marvel.com/movies/86303/destiny-arrives-brand-new-avengers-infinity-war-trailer-motion-poster/">Destiny Arrives with the Brand New 'Avengers: Infinity War' Trailer </a></h2>
			<h3><a  href="https://news.marvel.com/movies/86303/destiny-arrives-brand-new-avengers-infinity-war-trailer-motion-poster/">In Theaters April 27</a></h3>
		</div>
	</div>
</div>
<script>
...
<div style="background-color:black;">
	<div id="trailer_container">
		<div id="trailer_text">
			<h1>Marvel Studios' Avengers: Infinity War</h1>                  
		</div>
		<div  id="trailer_box">
			<div id="trailer">
				<iframe   src="https://www.youtube.com/embed/QwievZ1Tx-8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			</div>
			<div id="trailer_description">
				<h1>Avengers: Infinity War (Movie)</h1>
				<h3>Mar 16, 2018</h1>
				<h2><a href="https://www.youtube.com/embed/QwievZ1Tx-8">Avengers: Infinity War - Official Trailer #2</a></h2>
...
<div style="background-color:white">
	<div id="comics-container">
		...
		<div style="background-color:white">
			<div class="comicdiv">
				<img class="comics" src="portrait_incredible.jpg">
				<b>X-Men: Blue Annual #1</b><br>
				<span class="author">Bunn, Arteaga<span>
			</div>
			<div class="comicdiv">
				<img class="comics" src="portrait_incredible(12).jpg">
				<b>X-Men: Blue #20</b><br>
				<span class="author">Bunn, Silva<span>
			</div>
			<div class="comicdiv">
				<img class="comics" src="portrait_incredible(6).jpg">
				<b>GenerationX #13</b><br>
				<span class="author">Soule, Unzueta<span>
			</div>
			<div class="comicdiv">
				<img class="comics" src="portrait_incredible(5).jpg">
				<b>Thor #30</b><br>
				<span class="author">Rosenberg, Rosanas<span>
			</div>
			<div class="comicdiv">
				<img class="comics" src="portrait_incredible(4).jpg">
