...
<div id="reg-container">
		...
		<!-----form------------------------->
		<form action="registrationresp.php" name="myForm"  onsubmit="return validateForm()" method="post">
				<div  class="inputbox" align="center">
					<input align="center" type="text" id="FirstName" value="mm" name="FirstName" placeholder="  First Name" title="Enter First Name">
					<div id="fp"></div>
				</div>
				<div class="inputbox" align="center">
					<input align="center" type="text"  id="LastName" value="mm"  name="LastName" placeholder="  Last Name" title="Enter Last Name" >
					<div id="lp"></div>
				</div>
				<div class="inputbox" align="center">
					<input align="center" type="text" id="UserName" value="<?php echo $user ?>"  name="UserName" placeholder="  UserName" title="Enter UserName" >
			<!----php------------------->
					<?php if ($error!=="sameer"):?> 
							<div id="up"><?php echo $error; ?></div>
					<?php endif ?>
			<!----php------------------->		
				</div>
				<div class="inputbox" align="center">
					<input align="center" type="text" id="EmailID" value="sam@gdd.com" name="EmailID" placeholder="  email@address.com" title="Enter EmailID" >
					<div id="ep"></div>
				</div>
				<div class="inputbox" align="center">
					<input align="center" type="password" id="Password" value="1234@Qwerty" name="Password" placeholder="  Password" title="Enter Password" >
					<div id="pp"><br>
						Passwords must be at least eight characters in length and contain one capital letter, one lower case letter, one number and one special character (such as !@#$%^&*()[]”).
					</div>
				</div>
				<div class="inputbox" align="center">
					<input align="center" type="password" id="PasswordConfirmation" value="1234@Qwerty" name="PasswordConfirmation" placeholder="  Password Confirmation" title="Re-enter Password">
					<div id="pcp"></div>
				</div>
