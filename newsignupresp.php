...
<html>
<head>
<title>Marvel.com|SignUp</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet" type="text/css" href="body.css">
<link rel="stylesheet" type="text/css" href="signup-container.css">
...
<div id="signup-margin">
	<div id="signup-container">
			<div align="center"  id="signup-image">
				<div align="center">
					<img src="mi-left-logo.png" title="Marvel Insider">
				</div>
			</div>
			<div id="signup-inputs">
				<div align="center" id="signupsign">
					<a href="registrationresp.php">
						SignUp!
					</a>
				</div>
				<div align="center" style="font-weight: bold;font-size:20px">OR</div>
				<div align="center">
					<button id="facebookbutton"class="button-default button-slanted">
						<table>
							<tr>
								<td class="button-slanted-content">
									<img src="fb_logo.png" width="30" height="30" title="Sign in with Facebook">
								</td>
								<td class="button-slanted-content" style="font-family:TradeGothic LT;font-weight: bold;color:white">
				...
				<div align="center" style="font-family:Arial Narrow;font-size:20px"><u>Sign in with User Name</u></div>
				<!-----
				   FORM
				   ----------------->
		<form action="newsignupresp.php" name="myForm"  onsubmit="return validateForm()" method="post">
				<div  id="signusername" align="center">
					<input align="center" type="text" value="<?php echo $user; ?>" name="Username" placeholder="  Username" title="Enter Username" >
				</div>
				<div id="signpassword" align="center">
					<input align="center" type="password" value="<?php echo $pass; ?>" name="Password" placeholder="  Password" title="Enter Password" >
				</div>
			<?php if ($error!==""):?> 
				<div align="center" id="error"><?php echo $error; ?></div>
			<?php endif ?>
				<div  id="signsubmit" align="center">
					<button align="center" type="submit" name="submit" class="button-default button-slanted" >
				...
				<!-----
				   FORM ENDS
				   ----------------->
				<div align="center" style="font-family:TradeGothic LT;font-weight: bold;color:#5f5b5b;font-size:15px">Don't have an account? <a href="registrationresp.php" style="color:#5f5b5b">Create Account</a></div>
			</div>
	</div>
</div>
<!--footernav container--->
